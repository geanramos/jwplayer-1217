...
<html>
    ...
    <body>
		...
		<script src="//content.jwplatform.com/players/4R1shNaD-xBFjbFY2.js"></script>
		...
		playerInstance.on('firstFrame', function(event){
			...
			ga('send', 'event', 'JW Player Video', 'metric', 'time-to-first-frame-html5', loadTime);
		...
		playerInstance.on('ready', function(event){
			...
			console.log(loadTime);
			//ga('send', 'event', [eventCategory], [eventAction], [eventLabel], [eventValue], [fieldsObject]);
			ga('send', 'event', 'JW Player Video', 'metric', 'time-to-player-ready-html5	', loadTime);
